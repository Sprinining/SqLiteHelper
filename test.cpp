...
int main()
{
    string sql_tmid_select = "SELECT * from tmid where id = 28080001";
    ...
    string sql_user_select = "SELECT * from user where type = 2";
 ...
 //   dbhelper.table_tmid_insert(28080007, "°¢", "ÄÐ", "°²ÄÝ", 1.00, 65, 0.9, 100.00);
    ...
    //dbhelper.table_user_login("001", "666");
